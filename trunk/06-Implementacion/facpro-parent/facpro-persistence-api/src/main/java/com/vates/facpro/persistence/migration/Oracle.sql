...
/* Verision 2.0.10*/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (67, SYSDATE, SYSDATE, 0, null,'factura::getPendingOk','factura::getPendingOk', 0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (67, SYSDATE, SYSDATE, 0, null,'EJECUTAR',67)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (67, SYSDATE, SYSDATE, 0,'GET',67,null,0)
/
INSERT INTO ROLES_PERMISSIONS (PERMISSION_ID,ROLE_ID )
SELECT P.ID,2 FROM PERMISSIONS P
WHERE P.ID NOT IN (SELECT PERMISSION_ID FROM ROLES_PERMISSIONS WHERE ROLE_ID=2)
...
INSERT INTO ROLES_PERMISSIONS (PERMISSION_ID,ROLE_ID )
SELECT P.ID,4 FROM PERMISSIONS P
WHERE P.ID IN (67) AND P.ID NOT IN (SELECT PERMISSION_ID FROM ROLES_PERMISSIONS WHERE ROLE_ID=4)
/* Verision 2.0.10*/
...
/* Verision 2.1.0*/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (68, SYSDATE, SYSDATE, 0, null,'user::getAuthorizers','user::getAuthorizers',0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (68, SYSDATE, SYSDATE, 0, null,'EJECUTAR',68)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (68, SYSDATE, SYSDATE, 0,'GET',68,null,0)
/
INSERT INTO ROLES_PERMISSIONS (PERMISSION_ID,ROLE_ID )
VALUES (68,2)
/
...
/* Verision 2.1.0 0003*/
INSERT INTO MODULE(ID,CREATED_AT,UPDATED_AT,LOCK_VERSION,NAME,LARGE_NAME,ORD)
VALUES (4, SYSDATE, SYSDATE,0,'OC','Requerimientos de Compra',3)
/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (69, SYSDATE, SYSDATE, 0, null,'RC','Administracion', 1)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (69, SYSDATE, SYSDATE, 0, null,'ADMINISTRAR',69)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (69, SYSDATE, SYSDATE, 0,'Administrar Proveedores',69,'proveedor-admin',1)
/
INSERT INTO MODULE_RESOURCE (MODULE_ID,RESOURCE_ID)
VALUES (4, 69 )
/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (70, SYSDATE, SYSDATE, 0, null,'proveedor::getDatoInicial','proveedor::getDatoInicial',0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (70, SYSDATE, SYSDATE, 0, null,'EJECUTAR',70)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (70, SYSDATE, SYSDATE, 0,'GET',70,null,0)
/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (71, SYSDATE, SYSDATE, 0, null,'proveedor::getProveedor','proveedor::getProveedor',0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (71, SYSDATE, SYSDATE, 0, null,'EJECUTAR',71)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (71, SYSDATE, SYSDATE, 0,'GET',71,null,0)
/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (72, SYSDATE, SYSDATE, 0, null,'proveedor::proveedorPaginatedList','proveedor::proveedorPaginatedList',0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (72, SYSDATE, SYSDATE, 0, null,'EJECUTAR',72)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (72, SYSDATE, SYSDATE, 0,'GET',72,null,0)
/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (73, SYSDATE, SYSDATE, 0, null,'proveedor::saveProveedor','proveedor::saveProveedor',0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (73, SYSDATE, SYSDATE, 0, null,'EJECUTAR',73)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (73, SYSDATE, SYSDATE, 0,'POST',73,null,0)
/
INSERT INTO RESOURCES (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, REPRESENTATION, ORD)
VALUES (74, SYSDATE, SYSDATE, 0, null,'proveedor::delete','proveedor::delete',0)
/
INSERT INTO PERMISSIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, DESCRIPTION, NAME, RESOURCE_ID)
VALUES (74, SYSDATE, SYSDATE, 0, null,'EJECUTAR',74)
/
INSERT INTO PERMISSION_REPRESENTATIONS (ID, CREATED_AT, UPDATED_AT, LOCK_VERSION, REPRESENTATION, PERMISSION_ID, REPRESENTATIONPAGE, ORD)
VALUES (74, SYSDATE, SYSDATE, 0,'POST',74,null,0)
/
INSERT INTO ROLES_PERMISSIONS (PERMISSION_ID,ROLE_ID )
SELECT P.ID,2 FROM PERMISSIONS P
WHERE P.ID NOT IN (SELECT PERMISSION_ID FROM ROLES_PERMISSIONS WHERE ROLE_ID=2)
/
INSERT INTO ROLES (ID,CREATED_AT,UPDATED_AT,LOCK_VERSION,DESCRIPTION,NAME)
VALUES (8, sysdate, sysdate,0,'Un usuario con permisos de administrador de requerimientos de compra podrá acceder a todas las pantallas de RC'
,'Administrador de RC')
/
INSERT INTO ROLES_PERMISSIONS (PERMISSION_ID,ROLE_ID )
VALUES (69,8)
