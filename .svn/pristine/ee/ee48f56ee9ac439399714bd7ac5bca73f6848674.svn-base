...
public interface HistorialAutorizacionService extends
	...
	List<HistorialAutorizacion> findByuserAndFactura(Long idUsuario,
			Long idFactura);

	void saveHistorial(Long idFac, String descripcion, Long estado)
			throws Exception;

	void rechazarFacturaHistorial(Long idFac, String motivo) throws Exception;
	...
	void informar(Long idFactura, Long userId) throws Exception;
