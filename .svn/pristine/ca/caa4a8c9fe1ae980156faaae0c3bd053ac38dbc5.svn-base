...
caApp
		.config(function($routeProvider, $httpProvider) {
			...
			$routeProvider
					.when('/', {
						templateUrl : 'protected/main.html?i='+random,
						controller : 'MainController',
						label : 'Principal'

					})
					.when('/about', {
						templateUrl : 'protected/help/about.html?i='+random,
						label : 'Sobre'

					})
					.when('/help-contents', {
						templateUrl : 'protected/help/help-contents.html?i='+random,
						label : 'Ayuda'
					...
					// USER
					.when('/user-admin', {
						templateUrl : 'protected/user/user-admin.html?i='+random,
						controller : 'userAdminController',
						label : 'Administrar Usuarios'
					})
					.when('/user-admin/user-form', {
						templateUrl : 'protected/user/user-form.html?i='+random,
					...
					.when('/user-admin/user-assign-roles/:usId', {
						templateUrl : 'protected/user/user-assign-roles.html?i='+random,
						controller : 'userAssignRolesController',
						label : 'Asignar Roles'
					})
					// FACTURA
					.when('/factura-admin', {
						templateUrl : 'protected/factura/factura-admin.html?i='+random,
						controller : 'facturaAdminController',
						label : 'Gestionar Facturas'
					})
					.when('/factura-admin/factura-form', {
						templateUrl : 'protected/factura/factura-form.html?i='+random,
					...
					.when(
							...
							{
								templateUrl : 'protected/factura/factura-file-form.html?i='+random,
								controller : 'facturaFormEditFileController',
								label : 'Editar Archivos'
							})
					.when('/factura-admin/factura-wf-form-edit/:facId', {
						templateUrl : 'protected/factura/factura-wf-form.html?i='+random,
					...
					.when(
							...
							{
								templateUrl : 'protected/factura/factura-consult-admin.html?i='+random,
					...
					.when(
							...
							{
								templateUrl : 'protected/autorizacion/autorizacion-file-form.html?i='+random,
					...
					.when(
							...
							{
								templateUrl : 'protected/workflow/detalle-workflow-form.html?i='+random,
								controller : 'consultWFController',
								label : 'Detalle Workflow'
							})
					// FACTURA FILE
					.when('/factura-admin/file-form/:facId', {
						templateUrl : 'protected/file/file-form.html?i='+random,
					...
					.when(
							'/autorizacion-admin',
							{
								templateUrl : 'protected/autorizacion/autorizacion-admin.html?i='+random,
					...
					.when(
							...
							{
								templateUrl : 'protected/workflow/detalle-estados-form.html?i='+random,
					...
					.when(
							'/autorizacion-nivel-inferior',
							{
								templateUrl : 'protected/autorizacion/autorizacion-nivel-inferior.html?i='+random,
					...
					//ORDENES DE COMPAR
							...
							'/oc-admin',
							{
								templateUrl : 'protected/oc/oc-admin.html?i='+random,
								controller : 'oCAdminController',
								label : 'Administrar Ordenes de Compra'
							})
							.when(
							'/oc-admin/oc-form',
							{
								templateUrl : 'protected/oc/oc-form.html?i='+random,
							...
							'/oc-consult-admin',
							{
								templateUrl : 'protected/oc/oc-consult-admin.html?i='+random,
								controller : 'oCAdminConsultController',
								label : 'Reporte de Ordenes de Compra'
							})
					//		
					.otherwise({
