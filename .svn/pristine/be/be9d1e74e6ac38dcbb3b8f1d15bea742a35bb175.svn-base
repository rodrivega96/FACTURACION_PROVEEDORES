...
public class NivelServiceImpl extends
		AbstractBaseService<Nivel, Long> implements NivelService {
	...
	@Override
	public List<Nivel> findNivelByFacturaIdAndEliminado(long id, boolean eliminado) {
