caApp.controller('oCAdminController', function($scope, $location, $http,
	...
	$scope.states = getAllStateOC();
	
	$scope.goVigente = function() {
		var str = "Esta seguro de entrar en vigencia la OC?";
...
caApp.controller('oCFormController', function($scope, $location, $http,
	...
	$scope.states = getInitialStateOC();
...
caApp.controller('oCEditController', function($scope, $location, $http,
		ngTableParams, breadcrumbs, $cookieStore, webServices, tableFactory, $routeParams) {
...
caApp.controller('oCAdminConsultController', function($scope, $location, $http, 
		...
		$scope.findProyectFilterConsult = getFilterFindProyect();
		...
		$scope.findManagerFilterConsult = getFilterFindManager();
