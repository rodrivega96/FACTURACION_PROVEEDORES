...
public class HistorialAutorizacionServiceImpl extends
	...
	public void saveHistorial(Long idFactura, String motivo, Long estado)
		...
		adm.autorizar(fac, null,
				...
				nivelPublicadoRepository.findNivelPublicadoByFacturaIdAndLast(fac.getId(), true));
	...
	public void autorizarAnterioresHistorial(Long idFactura, Long userId,
		...
		List<Nivel> nivelesFactura = nivelRepository.findNivelByFacturaId(fac
				.getId());
		NivelPublicado nivelPublicadoLast = nivelPublicadoRepository.findNivelPublicadoByFacturaIdAndLast(fac.getId(), true);
		List<Nivel> listNvl = adm.getNivelesRestantes(fac, nivelesFactura, nivelPublicadoLast);
		for (Nivel nvl : adm.getNivelesRestantes(fac, nivelesFactura, nivelPublicadoLast)) {
			HistorialAutorizacion his = new HistorialAutorizacion();
			his.setFactura(fac);
			his.setNivel(nvl);
