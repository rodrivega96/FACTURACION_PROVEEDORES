caApp.registerCtrl('userAdminController', function($scope, $location, $http,
		ngTableParams, breadcrumbs, $cookieStore, webServices, paginatedFunction, USModel, utilidades) {
	...
	$scope.getActiveString = function (value) {
		return USModel.getStateMap()[value];
	};
