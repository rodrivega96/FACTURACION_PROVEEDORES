caApp.registerCtrl('autorizacionAdminController', function($scope, $location,
		...
		utilidadesConversion, tableCollapseFactory, paginatedFunction, AModel, utilidades) {
	...
	paginatedFunction.generatePaginatedMethod($scope, 'paginatedAutoName', null, 'filter.page', $scope.loadFacturas,
