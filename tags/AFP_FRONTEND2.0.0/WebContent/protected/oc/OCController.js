caApp.controller('oCAdminController', function($scope, $location, $http,
	...
	$scope.rollbackFilterFields = function() {
		...
		$scope.filter.totalPages = FiltroOC.data.totalPages;
	...
	$scope.loadFilterFields = function() {
		...
		FiltroOC.data.totalPages = $scope.filter.totalPages;
	};
	...
	$scope.goVigente = function(id, numero) {
		var str = "Esta seguro de entrar en vigencia la Orden de Compra "+numero+"?";
		var success ="La Orden de Compra "+numero+" se entro en Vigencia con exito";
		var fail ="Hubo un error al intentar entrar en vigencia la Orden de Compra "+numero;
		$scope.updateOc('changeStateOrden', id, str, success, fail );
	};
	
	
	$scope.goCerrar = function(id, numero) {
		var str = "Esta seguro de cerrar la Orden de Compra "+numero+"?";
		var success ="La Orden de Compra "+numero+" se cerro con exito";
		var fail ="Hubo un error al intentar cerrar la Orden de Compra "+numero;
		$scope.updateOc('closeOrden', id, str, success, fail );
	};
	
	$scope.goDelete = function(id, numero) {
		var str = "Esta seguro de desactivar la Orden de Compra "+numero+"?";
		var success ="La Orden de Compra "+numero+" se desactivo con exito";
		var fail ="Hubo un error al intentar desactivar la Orden de Compra "+numero;
		$scope.updateOc('deleteOrden', id, str, success, fail );
	};
	
	$scope.updateOc = function (ws, id, question, success, fail){
	...
	$scope.filterProject = getOCFilterProject();
	$scope.filterProposal = getOCFilterProposal();
