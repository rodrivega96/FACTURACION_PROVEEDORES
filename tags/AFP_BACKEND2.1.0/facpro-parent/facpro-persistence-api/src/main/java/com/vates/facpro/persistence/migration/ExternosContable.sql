...
SELECT
        ...
        0 AS NRO_CTRO_CTOS,
        '-' AS DESCRIPCION_CTRO_CTOS,
        AM.MASI_IMPORTE  AS IMPORTE_NETO,
        CTA.CTA_JERARQUIA
FROM
        PROVEEDOR PRO
                INNER JOIN COMPGRAL CGRAL
...
/* Version 2.0.4*/
/* Version 2.0.5 */
CREATE OR REPLACE VIEW "VIS_AUTORIZ_FAC_PROVEEDOR" ( "ID", "CUIT", "RAZON_SOCIAL", "NRO_FACTURA", "DESCRIPCION", "FECHA_VENCIMIENTO", "FECHA_CONTABLE", "FECHA_FACTURA", "GRAL_NETO", "GRAL_GRAV_IVA", "GRAL_NO_GRAV_IVA", "GRAL_IMP_INT", "GRAL_IVA_INC", "GRAL_IVA_NO_INC", "GRAL_BRUTO", "TIPO" )
AS
SELECT
        CGRAL.CGRAL_ID AS ID,
    PRO.PRO_NRO_CUIT CUIT,
