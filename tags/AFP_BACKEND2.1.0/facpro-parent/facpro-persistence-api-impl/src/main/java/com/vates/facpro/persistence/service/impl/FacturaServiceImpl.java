...
public class FacturaServiceImpl extends AbstractBaseService<Factura, Long> implements
	...
	@Override
	public Long findFacturaAdmByNroKanav(Long nroKanav, Long facturaAdmId) {
		return repository.findFacturaAdmByNroKanav(nroKanav, facturaAdmId);
	}

	@Override
	public String findFacturaNroByFacturaAdmId(Long id) {
		return facturaAdmRepository.findFacturaNroByFacturaAdmId(id);
	}	
}
